...
# Import ONLY Part 1 journeys
from journeys import (
    bounce, category_browse, search_discovery, search_discovery_success, product_explore
)

# Hardcoded Part 1 Map
JOURNEY_MAP = {
    "bounce": bounce,
...
def main():
    print("==================================================")
    print("   SINGITRONIC TRAFFIC ENGINE: PART 1")
    print("==================================================\n")
