...
def run_journey(page):
    ...
    print("  -> [Journey] Executing: Returning User Purchase")

    # By the time this function is called, the user is already authenticated
    ...
    print("  -> [Journey] Returning user successfully completed purchase.")
